...
-- Tournament 21-22: 特殊系
-- Tournament 21: Progressive Jackpot 2K
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(21,'entry','JPY',2000,15000,'プログレッシブJP',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(21,'reentry','JPY',2000,15000,'リエントリー',1);

-- Tournament 22: Lightning Round 800
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(22,'entry','JPY',800,8000,'ライトニング',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(22,'reentry','JPY',800,8000,'リエントリー',1);

-- Tournament 23-26: ミッドクイック系
-- Tournament 23: Rush Poker 1.5K
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(23,'entry','JPY',1500,12000,'ラッシュポーカー',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(23,'reentry','JPY',1500,12000,'リエントリー',1);

-- Tournament 24: Afternoon Quick 1K
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(24,'entry','JPY',1000,10000,'アフタヌーンクイック',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(24,'reentry','JPY',1000,10000,'リエントリー',1);

-- Tournament 25: Evening Start 2K
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(25,'entry','JPY',2000,15000,'イブニングスタート',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(25,'reentry','JPY',2000,15000,'リエントリー',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(25,'addon','JPY',1500,10000,'アドオン',1);

-- Tournament 26: Night Express 1.5K
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(26,'entry','JPY',1500,12000,'ナイトエクスプレス',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(26,'reentry','JPY',1500,12000,'リエントリー',1);

-- Tournament 27-30: 中級系
-- Tournament 27: Weekend Warrior 2.5K
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(27,'entry','JPY',2500,18000,'ウィークエンドウォリアー',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(27,'reentry','JPY',2500,18000,'リエントリー',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(27,'addon','JPY',2000,15000,'アドオン',1);

-- Tournament 28: Happy Hour 1.8K
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(28,'entry','JPY',1800,14000,'ハッピーアワー',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(28,'reentry','JPY',1800,14000,'リエントリー',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(28,'addon','JPY',1500,12000,'アドオン',1);

-- Tournament 29: Deep Night 5K
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(29,'entry','JPY',5000,35000,'ディープナイト',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(29,'reentry','JPY',5000,35000,'リエントリー',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(29,'addon','JPY',4000,30000,'アドオン',1);

-- Tournament 30: Ultra Deep 8K
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(30,'entry','JPY',8000,50000,'ウルトラディープ',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(30,'reentry','JPY',8000,50000,'リエントリー',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(30,'addon','JPY',6000,40000,'アドオン',1);

-- Tournament 31-40: 基本系
-- Tournament 31: Rapid Fire 800
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(31,'entry','JPY',800,8000,'ラピッドファイア',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(31,'reentry','JPY',800,8000,'リエントリー',1);

-- Tournament 32: Speed Play 600
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(32,'entry','JPY',600,6000,'スピードプレイ',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(32,'reentry','JPY',600,6000,'リエントリー',1);

-- Tournament 33: Power Play 1.2K
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(33,'entry','JPY',1200,10000,'パワープレイ',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(33,'reentry','JPY',1200,10000,'リエントリー',1);

-- Tournament 34: Blitz 900
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(34,'entry','JPY',900,9000,'ブリッツ',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(34,'reentry','JPY',900,9000,'リエントリー',1);

-- Tournament 35: Flash 700
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(35,'entry','JPY',700,7000,'フラッシュ',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(35,'reentry','JPY',700,7000,'リエントリー',1);

-- Tournament 36: Quick Strike 1.1K
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(36,'entry','JPY',1100,10000,'クイックストライク',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(36,'reentry','JPY',1100,10000,'リエントリー',1);

-- Tournament 37: Express 1.3K
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(37,'entry','JPY',1300,11000,'エクスプレス',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(37,'reentry','JPY',1300,11000,'リエントリー',1);

-- Tournament 38: Lightning 800
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(38,'entry','JPY',800,8000,'ライトニング',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(38,'reentry','JPY',800,8000,'リエントリー',1);

-- Tournament 39: Burst 1K
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(39,'entry','JPY',1000,10000,'バースト',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(39,'reentry','JPY',1000,10000,'リエントリー',1);

-- Tournament 40: Ultra Dash 1.5K
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(40,'entry','JPY',1500,12000,'ウルトラダッシュ',1);
INSERT INTO tournament_price(tournament_no,price_type,unit,price,stack,remark,enabled) VALUES(40,'reentry','JPY',1500,12000,'リエントリー',1);
